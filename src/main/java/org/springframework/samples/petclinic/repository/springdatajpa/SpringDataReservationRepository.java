...
/**
 * Spring Data JPA specialization of the {@link ReservationRepository} interface
 *
 * @author Michael Isvy
 */
public interface SpringDataReservationRepository extends ReservationRepository, Repository<Reservation, Integer> {
    ...
    @Override
    @Query("SELECT r FROM Reservation r ORDER BY r.reservationDate, r.reservationTime")

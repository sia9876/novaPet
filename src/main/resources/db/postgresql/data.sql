...
INSERT INTO reservations VALUES (1, 1, 2, '2026-10-01', '09:30', 'annual checkup', 'REQUESTED') ON CONFLICT DO NOTHING;
INSERT INTO reservations VALUES (2, 2, NULL, '2026-10-02', '14:00', 'vaccination', 'REQUESTED') ON CONFLICT DO NOTHING;
INSERT INTO reservations VALUES (3, 7, 3, '2026-10-03', '11:15', 'dental cleaning', 'CONFIRMED') ON CONFLICT DO NOTHING;
